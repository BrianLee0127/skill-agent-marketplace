...
Claude Code plugin marketplace. 15 items across 2 packages.
...
| Type | Name | What it does |
|---|---|---|
| skill | [tpp-microsite-architecture](team-toolkit\skills\tpp-microsite-architecture) | TPP microsite framework and project-structure scaffold for ASP.NET Core 8. 5-project Clean-Architecture-lite solution (Domain/Application/Infrastructure/API/Web), Web→API |

### UI & Design

| Type | Name | What it does |
|---|---|---|
| skill | [tpp-microsite-ui](team-toolkit\skills\tpp-microsite-ui) | TyrePlus/Michelin TPP microsite UI design template for ASP.NET Core MVC + Bootstrap 5. Green/yellow/blue brand tokens, gradient CTAs, form-section cards, 5-step wizard wi |
